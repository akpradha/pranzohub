...
<!-- Mirrored from codenpixel.com/demo/foodpicky/ by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 31 May 2018 05:14:18 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <div class="site-wrapper animsition" data-animsition-in="fade-in" data-animsition-out="fade-out">
        ...
        <header id="header" class="header-scroll top-header headrom">
         ...
         <div class="page-wrapper">
                  ...
                  <div class="row">
                     <div class="col-md-4 col-sm-6">
                        <div class="pricing-box">
                           <span class="price">
                           <span class="currency">₹</span>799</span>
                           <h2>Veg Breakfast</h2>
                     ...
                     <div class="col-md-4  col-sm-6">
                        <div class="pricing-box">
                           <span class="price">
                           <span class="currency">₹</span>949</span>
          ...
          <?php include 'modules/appsection.php';?>
            <!-- start: FOOTER -->
